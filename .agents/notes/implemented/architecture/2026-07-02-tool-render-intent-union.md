...
> The render-intent union remains current for UI transports; its ACP mapping is superseded by [ACP as an automation-only protocol](../../archived/simplification/2026-07-23-acp-automation-only-protocol.md).
