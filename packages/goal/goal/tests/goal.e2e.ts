...
const binScript = fileURLToPath(new URL('../../../test-support/loader-smoke/tests/fixtures/base-driver.ts', import.meta.url))
...
describe('goal domain through the production base bundle and process', () => {
