...
```sh
pnpm start --patch "$PWD/apps/server/config/examples/mcp-memory/memorix.cordis.yml"
```
...
pnpm start --patch "$PWD/apps/server/config/examples/mcp-memory/mcp-reference-memory.cordis.yml"
```
...
pnpm start --patch "$PWD/apps/server/config/examples/mcp-memory/engram.cordis.yml"
```
