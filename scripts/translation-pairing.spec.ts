...
describe('translation pairing switchers', () => {
  ...
  it('accepts only the canonical public URL for an absolute switcher', () => {
    const targets = languageSwitcherTargets('apps/server/README.zh.md')
    const canonicalMarkdown = '# README\n\nEnglish | [中文](https://github.com/deepseek-ai/deepseek-harness/blob/master/apps/server/README.zh.md)\n'
