...
const GENERIC_SKIPS: readonly GenericSkip[] = [
  ...
  { file: 'apps/server/tests/web-agent-presets.e2e.ts', upstream: ['cordis'] },
  ...
  { file: 'apps/server/tests/windows-shell.spec.ts', upstream: ['cordis'] },
...
/** Generated descriptor/codec contribution with no shared runtime identity. */`,
  ...
  },
  {
    ...
    file: 'apps/server/tests/web-agent-presets.e2e.ts',
    find: "import { Context } from 'cordis'",
    replace: "import { Context } from '@deepseek-ai/cordis'",
    expect: 1,
  },
