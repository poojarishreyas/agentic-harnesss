/**
 * Web backend configuration boot: resolve the profile and stack its
...
/** Absolute path of this dsh installation's package.json (both anchors: src/ and lib/ sit one level under apps/server). */
...
/**
 * Boot the backend configuration and retain process ownership through shutdown.
